...
public class FilesStorageServiceImpl implements FilesStorageService {
	...
	public void save(MultipartFile file) {
		logger.info("Start saving uploaded file......");
		try {
			...
			/** TODO
			 * Here, will add file screening function to guarantee the contents are meeting
	...
	public void saveAndRelay(MultipartFile file) {
		logger.info("Start saving uploaded file, which will be relayed to remote SFTP server......");
		try {
            Path root = Paths.get(uploadPath);
            if (!Files.exists(root)) {
                init();
		...
		logger.info("End saving uploaded file.");
	}
